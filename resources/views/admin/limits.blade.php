				...
				<div class="row mb-3">
					...
					<div class="col-sm-10">
						<select name="maximum_files_post" class="form-select">
							...
							<option @if( $settings->maximum_files_post == 30 ) selected="selected" @endif value="30">30</option>
							<option @if( $settings->maximum_files_post == 40 ) selected="selected" @endif value="40">40</option>
							<option @if( $settings->maximum_files_post == 50 ) selected="selected" @endif value="50">50</option>
							<option @if( $settings->maximum_files_post == 60 ) selected="selected" @endif value="60">60</option>
							<option @if( $settings->maximum_files_post == 70 ) selected="selected" @endif value="70">70</option>
							<option @if( $settings->maximum_files_post == 80 ) selected="selected" @endif value="80">80</option>
							<option @if( $settings->maximum_files_post == 90 ) selected="selected" @endif value="90">90</option>
							<option @if( $settings->maximum_files_post == 100 ) selected="selected" @endif value="100">100</option>
					 </select>
					</div>
				</div><!-- end row -->
				...
				<div class="row mb-3">
					...
					<div class="col-sm-10">
						<select name="maximum_files_msg" class="form-select">
							...
							<option @if( $settings->maximum_files_msg == 30 ) selected="selected" @endif value="30">30</option>
							<option @if( $settings->maximum_files_msg == 40 ) selected="selected" @endif value="40">40</option>
							<option @if( $settings->maximum_files_msg == 50 ) selected="selected" @endif value="50">50</option>
							<option @if( $settings->maximum_files_msg == 60 ) selected="selected" @endif value="60">60</option>
							<option @if( $settings->maximum_files_msg == 70 ) selected="selected" @endif value="70">70</option>
							<option @if( $settings->maximum_files_msg == 80 ) selected="selected" @endif value="80">80</option>
							<option @if( $settings->maximum_files_msg == 90 ) selected="selected" @endif value="90">90</option>
							<option @if( $settings->maximum_files_msg == 100 ) selected="selected" @endif value="100">100</option>
					 </select>
					</div>
				</div><!-- end row -->
