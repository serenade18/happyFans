                ...
                <div class="card bg-white shadow border-0">
                    ...
                    <div class="card-body px-lg-5 py-lg-5 position-relative">
                        ...
                        <div class="form-group">
                            <input type="datetime-local" id="datetime" autocomplete="off" required value="" min="{{ now()->addHours(1)->format('Y-m-d\TH:i') }}" max="{{ now()->addYear()->format('Y-m-d\TH:i') }}" class="form-control" name="date" placeholder="{{ __('admin.date') }} *">
